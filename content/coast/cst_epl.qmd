...
For NBA 2025, the EPL indicator was calculated across all realms, and the results are summarised here for the 190 coastal ecosystem types that were assessed. For more details on EPL, see the [general introduction](../integrated-findings /chl_epl_explained.qmd){target="_blank"} to this headline indicator.
