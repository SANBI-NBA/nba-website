...
For NBA 2025, the EPL indicator was calculated across all realms, and the results are summarised here for the 190 coastal ecosystem types that were assessed. For more details on EPL, see <!--# INSERT LINK TO EPL EXPLAINER PAGE -->.

## Coastal Ecosystem Protection Level

Proportionately, the coast is slightly more protected than the rest of the land and sea (@fig-eplgraph, @tbl-eplnumbers). This is positive given the myriad of benefits provided by coastal ecosystems and their disproportionately impacted <!--# insert link to coastal pressures and condition page --> and threatened status<!--# insert link to coast ets page -->.
