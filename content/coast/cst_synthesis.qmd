...
In addition to the [overall priority actions](../integrated-findings%20/pakg_actions.qmd){target="_blank"} distilled from this assessment, the 10 priority actions specifically for South Africa's coastal zone are given below.
