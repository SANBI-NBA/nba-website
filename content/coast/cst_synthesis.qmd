...
![De Hoop dunefield is an iconic feature in South Africa's coastal zone. Photo credit: © Peter Chadwick](imgs/cst-syn-De-Hoop_Peter-Chadwick.png){fig-align="center"}
...
**South Africa's coast is a national asset, rich in biodiversity, history and cultures that are all woven into the fabric of our national heritage.** Despite comprising only 4% of the mainland extent, the ecologically determined coastal zone (EDCZ) includes nearly a fifth (`r percent_types(cet_n, all_et)`%, i.e., `r cet_n`) of its `r all_et` ecosystem types. <!--# Check number of mainland ecosystem types. From the IEM, I understand it to be 467 T, 22 E, and 163 M ecosystem types = 652... but don't know latest stats for freshwater. I've excluded micro-estuaries. In 2018 we reported it as approximately a fifth of all ecosystem types. Need to update with final numbers. -->
...
<a href="https://www.iucnredlist.org/"><img src="imgs/cst-s-Tylos-granulatus_Linda-Harris.png" alt="Tylos granulatus EN" class="img-fluid"/></a> <br>*Tylos granulatus*<br>© Linda Harris
:::

::: {.g-col-lg-3 .g-col-6 .text-center}
<a href="https://www.iucnredlist.org/"><img src="imgs/cst-s-Tylos-capensis_Linda-Harris.png" alt="Tylos capensis EN" class="img-fluid"/></a> <br>*Tylos capensis*<br>© Linda Harris
:::

::: {.g-col-lg-3 .g-col-6 .text-center}
<a href="https://www.iucnredlist.org/"><img src="imgs/cst-s-Acanthoscelis-ruficornis_Linda-Harris.png" alt="Acanthoscelis ruficornis EN" class="img-fluid"/></a> <br>*Acanthoscelis ruficornis*<br>© Linda Harris
:::

::: {.g-col-lg-3 .g-col-6 .text-center}
<a href="https://www.iucnredlist.org/"><img src="imgs/cst-s-Donax-serra_Linda-Harris.png" alt="Donax serra EN" class="img-fluid"/></a> <br>*Donax serra*<br>© Linda Harris
:::
:::::::

## Priority actions

In addition to the overall priority actions distilled from this assessment<!--# insert link to overall priority actions/responses page -->, the 10 priority actions specifically for South Africa's coastal zone are given below.
