...
**Given the intensity and number of pressures to coastal biodiversity, half (48%) of the South African coast is no longer in a natural to near-natural state, and a quarter (26%) is severely/critically modified** (@fig-condmap, @fig-condgraph). Proportionately, there more than double the amount of modified habitat in the coastal zone than in non-coastal areas.

[Read more »](./cst_pressures-condition.qmd#cst-cond)

![Coastal ecological condition, 2025.](imgs/cst_cond_map_new2.png){#fig-condmap fig-align="center"}
