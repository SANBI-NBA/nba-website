...
![Coastal ecological condition, 2025.](imgs/cst_cond-map.png){#fig-condmap}
...
cst_cond_wd <- read_csv(here("outputs/cst_condition.csv")) %>%
  rename(`Severely / critically modified` = `Severely/critically modified`)
