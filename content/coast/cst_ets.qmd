...
For NBA 2025, the RLE framework was applied across all realms, and the results are summarised here for the 190 coastal ecosystem types that were assessed. For more details on ETS, see the [general introduction](../integrated-findings%20/chl_rle_explained.qmd){target="_blank"} to this headline indicator.
