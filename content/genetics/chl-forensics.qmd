...
Wildlife forensic science has emerged as a crucial tool in biodiversity conservation and law enforcement, particularly in combating illegal wildlife trade. In South Africa, a country renowned for its rich and diverse fauna, the need for robust forensic tools has become increasingly urgent. The illegal trade in wildlife and derivatives, ranging from rhinoceros horn and elephant ivory to abalone and pangolin, poses a substantial threat to national conservation efforts and undermines legal frameworks designed to protect threatened species.

In South Africa, laboratories responsible for wildlife forensic DNA analysis are contracted by local enforcement authorities (South African Police Service (SAPS) or Department of Forestry, Fisheries and the Environment (DFFE)) to provide this service based on their expertise and experience. Two laboratories within South Africa have mainly been responsible for the provision of wildlife forensic genetic analysis, namely the Genetic Services Unit (GSU) of the South African National Biodiversity Institute (SANBI) and the Veterinary Genetics Laboratory (VGL) of the University of Pretoria.
...
A comprehensive review of wildlife forensic cases analysed in South Africa between August 2017 and July 2024 was conducted [@de_bruyn_septennium_2025]. A total of 3 763 cases were examined, revealing significant trends in species representation and forensic demand (@fig-forensic-cases):
...
-   **Invertebrate** cases predominantly involved South African abalone (*Haliotis midae*), a species heavily targeted for illegal harvesting.
...
![Taxonomic representation of cases analysed in South Africa over a seven-year period (August 2017 to July 2024).](imgs/proportion-cases-taxon.png){#fig-forensic-cases width="max" height="max" fig-align="center"}

For a more in-depth look at the species and their representation in the various wildlife forensic cases analysed in South Africa, refer to [@fig-list] .

![Species representation of cases analysed in South Africa over a seven-year period (August 2017 to July 2024).](imgs/forensic-list-v3.png){#fig-list fig-align="center"}
