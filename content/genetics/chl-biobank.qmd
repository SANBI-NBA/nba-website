...
```{r}
#| label: tbl-biobank
#| tbl-cap: "Summary of biodiversity biobanks and holdings across institutions participating in the Biodiversity Biobanks South Africa (data as of 2025). Acronyms follow those listed in the Acknowledgements, with the exception of DNSM (Durban Natural Science Museum), MSB (Millennium Seed Bank), RBG-Kew (Royal Botanic Gardens, Kew), and UP-CMW-IA (University of Pretoria, Culture Monitoring Wing, Innovation Africa)."
#| classes: plain
