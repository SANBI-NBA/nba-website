...
![Figure 1. Rate of habitat loss (RoL) indicator for the period 1990–2022, calculated for each terrestrial ecosystem type.](imgs/RoD_map_Kagiso.png){#landcover fig-align="center" width="600"}
...
**The rates and patterns of habitat loss in South Africa are explored at [biome level](./biome_lcc.qmd) and [provincial level](./prov_lcc.qmd) in these pages.**
