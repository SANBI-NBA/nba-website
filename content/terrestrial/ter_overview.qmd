...
Thirty percent of South Africa's terrestrial ecosystem types are listed as threatened, which translates to 11% of the remaining natural habitat. There has been an overall increase in the risk of collapse of terrestrial ecosystems since 2014. While a quarter of terrestrial ecosystem types are Well Protected, the same percentage are Not Protected. The overall trend for protection is positive, with a steady increase in the Protected Areas network - primarily due to biodiversity stewardship programs. The full results can be found on the [ecosystem threat status page](./ter_ets.qmd) and [ecosystem protection level page](./ter_epl.qmd).
