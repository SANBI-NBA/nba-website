...
The Saving Marion Island's Seabirds: The Mouse-Free Marion Project has committed to eradicating the mice in a collaborative effort led by BirdLife South Africa and the Department of Forestry Fishereies and the Environment. Significant research effort has been directed to increase the probability of success of the largest island-wide eradication of rodents in the world, although financial constraints have impaired progress. To help save Marion Island’s seabirds visit <https://mousefreemarion.org/>.
...
![Ecosystem protection level map of the Prince Edward Islands and surrounding exclusive economic zone (EEZ). Terrestrial ecosystems, represented in white, are all Well Protected. The inset shows the number and proportion of ecosystems types in each protection level category.](imgs/protection.png){#fig-pei-epl fig-align="center" width="600"}
