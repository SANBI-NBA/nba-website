...
**In the estuarine realm, 32% of ecosystem types are both highly threatened and under protected, prevalent on the Cool Temperate and Subtropical biogeographical regions.** These include the following seven ecosystem types:
...
**More than 53% of South Africa's estuaries are healthy, but this amounts to only 18% of total estuarine extent, comprised mostly of small estuaries.** **Concerning overall, more than 70% of estuarine area is significantly modified.**
...
::: {.g-col-lg-5 .g-col-12}
![Map of ecosystem degradation showing the spatial distribution of estuaries in natural/near natural, moderately degraded, severely degraded or critically degraded state. Click to expand.](imgs/cnd.png){.lightbox}
:::
:::::
