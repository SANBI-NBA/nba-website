...
```{r}
#| label: fig-ets_map
#| fig-cap: Map showing the distribution of threatened estuarine ecosystems according to the IUCN Red List of Ecosystems (size of the dot represents area of the individual estuary)
#| echo: false
#| message: false
#| warning: false
#| out-width: 100%
...
#| echo: false
#| fig-cap: Ecosystem threat status of South Africa’s estuaries presented as percentage of ecosystems types (a) and percentage ecosystems extent (b).
#| out-width: 100%
#| classes: plain
...
#| echo: false
#| tbl-cap:  Ecosystem threat status of South Africa’s estuaries tabulated by type, extent and percentage area
#| out-width: 100%
#| classes: plain
...
```{r}
#| label: tbl-ets
#| tbl-cap: Ecosystem threat status of South Africa’s estuaries
#| classes: plain
