...
{r} #\| label: fig-cum-press #\| fig-cap: Map of 31 cumulative pressures in South Africa's ocean. Red and orange areas ahve the highest cumulative pressure, with blue areas showing low pressure. White areas have no mapped pressures. #\| echo: false #\| out-width: 100%
...
{r} #\| label: fig-seismic-pressure #\| fig-cap: Spatial mapping of seismic surveys in South African waters between 1980 and 2020. Sink et al. 2025 #\| echo: false #\| out-width: 100%
...
{r} #\| label: fig-oil-gas-pressure #\| fig-cap: Map of cumulative pressure used in the NBA 2018. #\| echo: false #\| out-width: 100%
...
{r} #\| output: asis #\| label: lst-citation-code

library(nbaR) library(knitr) library(rmarkdown)
...
meta \<- knitr::opts_knit\$get("rmarkdown.pandoc.to") \# forces knitr to load metadata meta \<- rmarkdown::metadata \# full YAML is now in `meta`
