...
Highly threatened and under-protected ecosystem types are candidates for improved protection through formal protected areas expansion or other spatial management measures such as biodiversity stewardship or other effective area-based conservation measures (OECMs).
...
Protection level assessment: Skowno, A.L. 2025. SANBI-NBA Estuary ecosystem protection level \[Source code\]. GitHub repository available at [htthttps://github.com/SANBI-NBA/estuary-epl-analysis](https://github.com/SANBI-NBA/estuary-epl-analysis){.uri}

Threat status assessment: Skowno, A.L. 2025. SANBI-NBA Estuary ecosystem threat status \[Source code\]. GitHub repository available at <https://github.com/SANBI-NBA/estuary-rle-analysis>.
