...
Overall, estuaries are Moderately (`r perc_mp_extent`%) to Poorly (`r perc_pp_extent`%) protected in South Africa, less than 1% of the area is well protected. Of concern is that about `r perc_np_extent`% of estuarine extent is Not Protected. From an ecosystem types perspective about `r perc_wp_count`% are Well protected, `r perc_mp_count`% Moderate, `r perc_pp_count`% Poorly, and `r perc_np_count`% Not Protected.

Of concern, three estuarine ecosystem types are categorised as Not Protected, namely:

-   Warm Temperate Large Fluvially Dominated
-   Subtropical Estuarine Bay
-   Cool Temperate Predominantly Open

Similarly, nine estuarine ecosystem types are categorised as Poorly Protected, and are represented by:
...
An investment in estuarine protection is needed in ecosystem types that are Not Protected, or to advance Poorly Protected ecosystem types towards Well Protected. Ecosystem types in the Tropical and Warm Temperate biogeographical region are the most well protected, while ecosystem types in the Cool Temperate regions are the least protected.
...
Several under protected ecosystem types can advance to Well Protected solely with improved management of fishing and water quality. For example, 32% of estuarine ecosystem types and 10% of the total estuarine area can be Well Protected if fishing efforts in just 3 estuaries are better controlled. These estuaries are Langebaan, Knysna and Kosi.
...
![Aerial view of Rondevlei in the foreground and Langvlei in the background. (SANParks) (© SANParks)](imgs/DJI_0178.jpg){width="90%"}
...
::: {.column width="38%"}
![The cyanobacteria algal bloom event on Island Lake in 2025. (© SANParks)](imgs/PHOTO-2025-04-02-14-02-04.jpg)
:::
::::::
...
![Arial view of Island Lake in the foreground with Langvlei in the center and Rondevlei in the far distance. (© SANParks)](imgs/DJ_0166.jpg)
:::::::
