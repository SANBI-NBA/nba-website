...
| [32%]{.inline-style-poorly-protected}
| of estuarine extent
...
| [59%]{.inline-style-moderately-protected}
| of estuarine extent
...
#| fig-cap: Schematic representation of estuarine ecosystem protection levels (size of the dot represents area of the individual estuary). There are many overlaps between points that can obscure the status of smaller estuaries.
#| echo: false
#| message: false
#| warning: false
#| out-width: 100%
...
#| echo: false
#| fig-cap: Estuarine Ecosystem Protection Levels in South Africa by percentage of types (# contributing estuaries indicated on bar) (a) and percentage extent (b).
#| out-width: 100%
#| classes: plain
...
#| echo: false
#| tbl-cap: Estuarine Ecosystem Protection Levels in South Africa tabulated by ecosystem type, extent (km2) and percentage extent (%)
#| out-width: 100%
#| classes: plain
...
tbl <- epl_combined %>% 
  ...
  #mutate(across(where(is.numeric), if_else(metric == "Percentage", paste(., "%")))) %>% 
  gt::gt(
    rowname_col = "metric",
    groupname_col = "zone",
