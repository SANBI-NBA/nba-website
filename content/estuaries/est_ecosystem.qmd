...
author:
  ...
  - name:
      given: Jane K.
      family: Turpie
    orcid: 0000-0003-1220-6295
    affiliations:
      - ref: Anchor1
  - name:
      given: Anusha 
      family: Rajkaran
    orcid: 0000-0001-7360-3660
    affiliations:
      - ref: UWC1
  - name:
      given: Steven P.
      family: Weerts
    orcid: 0000-0002-9826-3209
    affiliations:
      - ref: CSIR1
      - ref: CRUZ1
  - name:
...
# See README for common examples - they can be copied and pasted here
  ...
  - id: NMU1
    number: 2
    name: Institute for Coastal and Marine Research, Nelson Mandela University,Gqeberha, South Africa 
  - id: NMU2
    number: 3
    name: DST/NRF Research Chair in Shallow Water Ecosystems, Nelson Mandela University, Gqeberha, South Africa
  - id: SAIAB1
    number: 4
    name: South African Institute for Aquatic Biodiversity, Makhanda, South Africa 
  - id: DFFE1
    number: 5
    name: Department of Environment, Forestry and Fisheries, Cape Town, South Africa     
  - id: ORI1
    number: 6
    name: Oceanographic Research Institute, SAAMBR, Durban, South Africa    
  - id: UKZN1
    number: 7
    name: School of Life Sciences, University of KwaZulu-Natal, Durban, South Africa   
  - id: Anchor1
    number: 8
    name: Anchor Environmental Consultants, Cape Town, South Africa       
  - id: UWC1
    number: 9
    name: Biodiversity and Conservation Biology, University of the Western Cape, Cape Town, South Africa   
  - id: CRUZ1
    number: 10
    name: Department of Zoology and CRUZ, University of Zululand, KwaDlangezwa, South Africa   
...
est_ecotypes %>%
  gt() %>%
  gt::tab_style(style = list(gt::cell_fill(color = "#028A85"),
...
```{r est_ecosystem_types} 
# 
# #[Estuarine ecosystem types in South Africa]{style="color:white"} 
# 
# <!-- #| label: tbl-eco_types  -->
# <!-- #| #| echo: false  -->
# <!-- #| classes: plain  -->
# # <!-- #| tbl-cap: Estuarine ecosystem types in South Africa and the IUCN functional group codes that they align with in the [Global Ecosystem Typology](https://global-ecosystems.org/). -->
```
