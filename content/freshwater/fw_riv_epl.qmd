...
![Ecosystem protection level for river ecosystem types. The inset graph shows the number of ecosystem types per protection level category.](imgs/riv_epl_map.png){#fig-epl_riv_map} <!-- # ```{r} --> <!-- #| label: fig-riv_epl_map --> <!-- #| fig-cap: Map showing the river ecosystem protection level (EPL) and a donut plot summarising the number of river types in each EPL category. # checkNancy, check caption --> <!-- #| echo: false --> <!-- #| message: false --> <!-- #| warning: false --> <!-- #| out-width: 100% --> <!-- knitr::include_graphics("imgs/riv_epl_map.png") # ("imgs/riv_epl_map.png") --> <!-- ``` -->
