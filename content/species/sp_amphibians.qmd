...
taxon_data <- prep_taxon_data(df, "Amphibians")
...
::: {#box-1 .callout-note .species title="Box 6. Species box" collapse="true"}
## Box 1. Title
...
:::::: {#box-2 .callout-note .species title="Box 6. Species box" collapse="true"}
## Box 2. Title
...
dat1 <- dat1 %>% filter(dat1$`Taxon groups` == "Amphibians")
dat2 <- dat2 %>% filter(dat2$`Taxon groups` == "Amphibians")
plot1 <- nba_plot(dat1,
                  biome,
                  2:5,
                  CHRT = "donut",
