...
<<<<<<< HEAD
![*Hyperolius pickersgilli*, a species that has received extensive collaborative conservation focus over the last decade in South Africa. These efforts have resulted in its protection level improving from poorly protected in 2018 to moderately protected in 2025. (© Tyrone Ping)](./imgs/sp_amphibian_img_1.png){fig-align="center"}
=======
![Pickersgill's reed frog (*Hyperolius pickersgilli*), a species that has received extensive collaborative conservation focus over the last decade in South Africa. These efforts have resulted in its protection level improving from poorly protected in 2018 to moderately protected in 2025. (© Tyrone Ping)](./imgs/sp_amphibian_img_1.png){fig-align="center"}
>>>>>>> dev
...
Sightings (including roadkill) of this species by the public can be uploaded to iNaturalist, with sightings in the Overberg specifically to: [iNaturalist](https://www.inaturalist.org/projects/leopard-toads-of-the-overberg).
::::
::::::
:::::::::::
...
```{r}
#| label: tbl-3
#| tbl-cap: List of some of the active recovery projects focused on amphibians across South Africa, led by a range of different organisations.   
#| classes: plain
library(readxl)
library(dplyr)
library(gt)
