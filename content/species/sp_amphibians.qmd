      ...
      pmap_chr(list(x, img_paths, photographers), function(taxon_text, img_path, photographer) {
        if (!is.na(img_path)) {
          paste0(
            ...
            "<br><span style='font-size: 9px; font-style: italic; color: #666;'>Image credit: </span>",
...
```{r}
#| label: fig-5
#| fig-cap: "Key pressures on South Africa’s amphibians, based on the percentage of impacted threatened species, using the IUCN Threat Classification Scheme (IUCN, 2025)."
#| fig-align: center
#| out.width: 100%
...
::: right
![](./imgs/sp_amphibian_img_15.png){fig-alt="habitat loss" style="width:100%; height:300px; object-fit:cover; border-radius:10px; margin-bottom:10px;"} [© Luke Verburght]{style="width:75%; color:#626262;"}
