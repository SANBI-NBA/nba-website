...
To support recovery, farm dams within or near the Lomati catchment have been stocked with wild-caught and captive-bred individuals. To date, 23 dams have been stocked in Eswatini and South Africa (including dams within the Kruger National Park), with an estimated \~50% showing signs of success by 2025. Additional stocking has also been done in the upper river within the species’ historical range. The captive breeding programme has been highly successful, with \>30 breeding events producing \~1 500 juveniles. However, based on the IUCN guidelines, stocked individuals can only be considered part of the natural population once they persist independently in natural systems for at least ten years, independent of human support. In other words, the species needs to persist for atleast three generations, which for *Chetia brevis* is between 9 to 12 years (estiamte generation length of 3-4 years, active research underway to confirm this estimate). In total, more than 30 000 fish (wild and captive-bred) have been stocked in dams.
