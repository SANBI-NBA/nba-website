...
![*Pycnacantha tribulus* (Fabricius, 1781), the hedgehog spider, was the first spider species described from South Africa, 244 years ago. © Peter Webb.](./imgs/sp_spider_img_1.png){fig-align="right" fig-alt="Pycnacantha tribulus"}
...
::::: grid
::: {.g-col-lg-6 .g-col-6 .text-center}
![Fogging trees at Lajuma, Limpopo province to sample arachnids in the tree canopy. © Elsa van Niekerk.](./imgs/sp_spider_img_3.png){.img-align1}
:::

::: {.g-col-lg-6 .g-col-6 .text-center}
![Reginald Christiaan, a BIOTA intern, sampling plant-dwellers at Soebatsfontein, Northern Cape province. © Robin Lyle.](./imgs/sp_spider_img_4.png){.img-align1}
:::
:::::
::::::
...
[Spiders of South Africa iNaturalist](https://www.inaturalist.org/projects/spiders-of-south-africa)
...
::: {.g-col-lg-3 .g-col-6 .text-center}
![*Afrofilistata fradei* © G. Wilson [Filistatidae](https://www.inaturalist.org/observations?place_id=6986&taxon_id=49331) (estimated to be 6 spp.)](./imgs/sp_spiders_img_11.png){.img-align}
:::
