...
```{r}
#| label: fig-4
#| fig-cap: "Key pressures on South Africa’s freshwater fishes. This analysis presents the relative frequency of pressures affecting threatened species, using the IUCN Threat Classification Scheme."
#| out.width: 100%
...
```{r}
#| label: fig-5
#| fig-cap: "Protection level results for the freshwater fishes of South Africa." 
...
```{r}
#| label: tbl-4
#| tbl-cap: "List of contributors to mobilising IUCN Red List assessments and support with field work." 
#| classes: plain
