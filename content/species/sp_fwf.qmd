...
```{r}
#| label: fig-1
#| fig-cap: "Spatial distribution of threatened freshwater fishes. The legend reflects the number of threatened freshwater fishes per 10 x 10 km grid cell. Darker shading shows areas are where threatened freshwater fishes are concentrated. Highest concentrations of threatened taxa coincide with areas of high endemism, highlighting the vulnerability of these range-restricted species to multiple anthropogenic pressures. These are chiefly related to invasive alien species, pollution and habitat degradation."
#| out-width: 650px 
...
```{r}
#| label: fig-2
#| fig-cap: "Summary of the threat status of freshwater fishes of South Africa based on the IUCN 3.1 Red List categories. The portion of species in each category is shown in the larger circle (A), and the proportion of endemic species per category is shown in the smaller circle (B). The total number of taxa that have been assessed are shown inside the circles." 
#| out-width: 100%
#| out-height: "auto"
...
```{r}
#| label: fig-4
#| fig-cap: "Key pressures on South Africa’s freshwater fishes. This analysis presents the relative frequency of pressures affecting threatened and Near threatened species, using the IUCN Threat Classification Scheme[@i2025a]."
#| out.width: 100%
...
See Box 2, [Freshwater Realm Species Summary](../freshwater/fw_overview.qmd).<!-- Will update when Freshwater page is complete -->
...
:::: {#box-4 .callout-note .species title="Box 4. Provincial monitoring efforts - Western Cape - CapeNature" collapse="true"}
