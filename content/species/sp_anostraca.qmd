...
-   There are 40 described Anostraca species in South Africa, representing \~11% of the world's species (\~353)[@rogers2013a].
...
![](./imgs/sp_anostraca_img_2.png)[A diversity of temporary habitats, varying in how and how often they are inundated. (© Betsie Milne, Musa Mlambo and Daksha Bills)]{style="font-size:90%; color:#626262;"}
:::
...
```{r}
#| label: fig-3
#| fig-cap: " The Red List Index (RLI) for Anostraca taxa assessed in South Africa (RLI  value = 0.84). The slope of the line indicates the rate at which species within each taxonomic group are becoming more threatened over time. The lower the value, the closer the group of species is heading towards extinction (if the value is 0, all species are extinct). This is the first assessment for Anostraca, and it is only represented by a single point."
#| out-width: 65%
