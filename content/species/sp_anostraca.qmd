...
- There are 40 described fairy shrimp (Anostraca) species in South Africa, representing around 11% of the world's 353 species[@rogers2013a].

- A comprehensive assessment of 36 Anostraca species was conducted for the first time using the IUCN Red List of Threatened Species Categories and Criteria to classify their risk of extinction (six species are still in review).

- Of the assessed taxa, nine species (25%) were assessed as threatened with extinction, and of these, two species are considered Critically Endangered (Possibly Extinct) [@meyer-milne-a].

- Endemism is high, with 44% (16) species only found in South Africa. Of these, 56% (9 species) are threatened with extinction, placing sole responsibility on South Africa to protect and conserve these species [@meyer-milne-a].
...
```{r}
#| label: fig-1
#| fig-cap: "Threatened Anostraca richness across South Africa, mapped as the number of threatened species per 10 x 10 km grid cell."
#| out-width: 650px
...
![](./imgs/sp_anostraca_img_2.png)[A diversity of temporary habitats, varying in how they are inundated and the frequency of inundation. (© Betsie Milne, Musa Mlambo and Daksha Bills)]{fig-align="center"}
:::

## Trends – the Red List Index

The trend in species status over time was measured using a global standard indicator, the IUCN Red List Index (RLI) of species [@butchart2004a]. The RLI is calculated for each taxonomic group based on genuine changes in Red List status over time. The RLI value ranges from 0 to 1. At a value of 1, all species are at low risk of extinction (Least Concern), while a value of 0 indicates that all species are extinct. The Red List Index of Anostraca was calculated for the first time for South Africa, and this group is relatively low on the RLI scale, with a value of 0.84 (@fig-3). This indicates that the group has high levels of threat and that many species are at risk of extinction.

```{r}
#| label: fig-3
#| fig-cap: " The Red List Index (RLI) for Anostraca taxa assessed in South Africa (RLI  value = 0.84). The slope of the line indicates the rate at which the risk of extinction of plants within each biome is changing over time. A lower value means more species are at high risk of extinction. The aggregate trend line shows the Red List Index for all taxonomic groups included in South Africa’s RLI. This is the first assessment for Anostraca, and it is only represented by a single point."
#| out-width: 100%
...
- Active search campaigns should be launched for the possibly extinct species, *Streptocephalus gracilis* and *Rhinobranchipus martensi*, as well as for the Data Deficient species, *Branchipodopsis scambus* and *Streptocephalus vitreus*.
...
![](./imgs/sp_anostraca_img_3.png){style="font-size:90px; color:#626262;"}
...
::: {fig-align="center"}
Using soils collected from dry habitats to run hatching trials, has successfully contributed to filling distribution gaps and describing new species. (© Betsie Milne)
:::
::::::::
...
- [Department of Science, Technology and Innovation](https://www.dsti.gov.za/)
- [University of KwaZulu-Natal](https://ukzn.ac.za/)
- [Freshwater Research Centre](https://www.frcsa.org.za/)
...
contributors_tbl <- data.frame(Contributors = c("Anisha Dayaram", "Carol Poole",
    "Jenny Day",
    "Michelle Hamer",
    "Tamuka Nhiwatiwa",
    "Esethu Nkibi"),
