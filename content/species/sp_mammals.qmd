...
```{r}
#| label: fig-5
#| fig-cap: "Key pressures on South Africa’s mammals, based on the relative frequency of pressures affecting threatened species, using the IUCN Threat Classification Scheme [@i2025a]. The percentage of threatened and Near threatened species impacted by specific pressures are presented. "
#| out.width: 100%
...
About species threat status: See details about how the IUCN Red List assessments are conducted [here](../integrated-findings/chl_spl_explained.qmd).
...
About species protection level: See details about how the Protection level indicator was conducted [here](../integrated-findings/chl_spl_explained.qmd).
...
3.  Oliver, C., Conservation and Data Scientist, Endangered wildlife Trust. Available at: https://figshare.com/ndownloader/files/60064052. Accessed: 03 December 2025.
