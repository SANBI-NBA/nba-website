...
- South Africa’s indigenous flora has high levels of diversity and endemism: 13 642 of the 20 248 [^1] taxa (67%) are endemic, with a high concentration of endemism in the south-western region of the Fynbos biome, and moderate concentrations in the arid regions, low escarpment bushveld, and coastal grasslands.
...
```{r}
#| label: fig-1
#| fig-cap: "Threatened plant richness across South Africa, mapped as the number of threatened plants per 10 x 10 km grid cell."
#| out-width: 650px
...
```{r}
#| label: fig-2
#| fig-cap: "Threat status of a representative sample of 900 South African plant taxa, showing all indigenous taxa (A), compared to taxa endemic to South Africa (B)." 
#| out-width: 100%
#| out-height: "auto"
...
<figcaption>Traditional healers receiving seedlings of the pepper bark tree ([*Warburgia salutaris*](https://redlist.sanbi.org/species.php?species=925-2)*)* to support conservation and sustainable use of this culturally important medicinal species. (© SANParks)</figcaption>
...
The RLI indicates a slow but consistent increase in the risk of extinction of plants. About 5% of sampled taxa became more threatened between 1990 and 2018, with a further 2% increase in threat between 2018 and 2024. Plants occurring in the Desert and Succulent Karoo biomes declined most rapidly between 2018 and 2024 (@fig-3) due to increasing pressures from climate change and habitat loss from mining and renewable energy developments. Most of these taxa occur in the Northern Cape. The province has experienced a prolonged drought over the past decade, which has exacerbated the effects of livestock overgrazing, mining, and renewable energy developments. This same region is also being heavily impacted by the illegal trade of ornamental succulent and geophytic plants (see [Box 2](#box-2)). The RLI for plants in the Forest biome improved due to reduced habitat pressure from clearing invasive species and targeted conservation interventions (see [Box 1](#box-1)).
...
```{r}
#| label: fig-3
#| fig-cap: "The Red List Index (RLI) for South African plants, disaggregated by biome. The slope of the line indicates the rate at which the risk of extinction of plants within each biome is changing over time. A lower value means more species are at high risk of extinction. The aggregate trend line shows the Red List Index for all taxonomic groups included in South Africa’s RLI."
...
```{r}
#| label: fig-4
#| fig-cap: "The distribution of plants that have increased in threat status since 2018, based on a representative sample of 900 plants."
#| out-width: 650px
...
#| label: fig-8
#| out-width: 650px
#| fig-cap: "Changes in protection level assessments between 2017 and 2024 for a representative sample of 900 plants."
