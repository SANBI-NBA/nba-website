...
```{r}
#| label: fig-1
#| fig-cap: "Threat status of 191 South African sharks, rays and chimaeras were assessed following the IUCN 3.1 Red List Categories and Criteria. The proportion of species in each category is shown in the larger circle for all species assessed, and the proportion of endemic species per category is shown in the smaller circle, in both circles the total number of species are indicated in the middle." 
#| out-width: 100%
#| out-height: "auto"
...
::: {#box-1 .callout-note .species title="Box 1. South Africa’s Diverse Shark Assemblage" collapse="true"}
South Africa hosts one of the richest and most diverse shark assemblages in the world. Globally, there are approximately 1 266 species, of which 191 are found in South African waters, including 13 endemic species [@ebert2021a]. This assemblage represents important ecological and cultural values as well as commercial value [@d2023a].
...
The RLI was calculated for all sharks in South African waters (n = 191), using national status assessments where available and global status assessments otherwise. The Shark RLI shows that many of South Africa’s shark species were already threatened in 2005 (@fig-2). The RLI declined further between 2005 and 2020, meaning that South Africa’s shark species continued to move towards extinction.
...
South African fisheries are well developed, with a high degree of industrialisation [@silva2015a]. Threats to sharks, rays and chimeras associated with small-scale fisheries are probably lower in South Africa than in some other coastal countries in the region. However, pressure from illegal coastal gillnet fisheries in estuaries and the open sea along the entire South African continental coastline is growing, representing an increasing threat to both legal fisheries and sharks [@d2025a]. In some areas, catches and landings of sharks in illegal gillnets at sea likely exceed landings from legal gillnets [@d2025a]. The illegal gillnet fishery is characterised by exceptionally high bycatch, especially when nets are set in estuaries and other nursery areas [@d2025a].

![The St Joseph shark (*Callorhynchus capensis*) is also known as the ploughnose chimaera or elephantfish. Although this is a fisheries target species, it is assessed as Least Concern. (© Geoff Spiby, Two Oceans Aquarium)](./imgs/sp_sharks_img_3.png){fig-align="center"}
...
```{r}
#| label: tbl-2
#| tbl-cap: "Major pressures on South Africa’s six threatened endemic shark species."
#| out-width: 650px
#| classes: plain
...
![The Agulhas Bank MPA protects mesophotic kelp forests and gardens of coralline algae on the offshore volcanic pinnacle. The rare speckled guitarfish (*Acroteriobatus ocellatus*, DD) has been observed in this MPA. (© Georgina Jones)](./imgs/sp_sharks_img_4.png){fig-align="center"}
...
Sharks need a refuge from fishing pressure. Marine protected areas (MPAs) and other effective area-based conservation measures (OECMs) can play an important role in safeguarding nursery grounds and other essential habitats. Existing MPAs that safeguard important shark habitat include the uThukela Banks, an important nursery areas for several shark species, Protea Banks, which is a known aggregation site for several species, and the Southwest Indian Seamount MPA, which incorporates habitats identified as globally significant for the conservation of shark species in the region [@d2023a]. Such measures are most relevant to resident species, but even highly mobile species often depend on specific sites for one or more key life-cycle processes and may be philopatric.

![The yellowspotted skate (*Leucoraja wallacei*) is an endemic skate that is Vulnerable but now receives some protection in the Amathole offshore and Agulhas Bank marine protected areas. (© ACEP Deep Forests Project, Kerry Sink)](./imgs/sp_sharks_img_5.png){fig-align="center"}
...
Important sites that are not protected through MPAs or OECMs can be incorporated into Critical Biodiversity Areas, a focal element in South Africa’s process spatial planning system. In addition to MPAs and OECMs, other spatial conservation and management processes, including Environmental Impact Assessments, estuarine management plans, and integrated coastal management plans, need to be directed to consider shark conservation [@d2023a].
...
Scientific research is essential to improve our understanding of shark biology, ecology, and population status, for assessing the impact of human activities on sharks, and informing management [@d2023a].
...
![In 2025, a specimen of largetooth sawfish (*Pristis pristis*) washed up on a beach near East London with the most recent prior record from a sawfish caught in a shark net in 1999. These previously not uncommon sharks have been considered as the first likely local extinction of a marine species in South Africa but are both Critically Endangered (© Kevin Cole, East London Museum)](./imgs/sp_sharks_img_6.png){fig-align="center"}
