...
::: {.column width="60%"}
![](imgs/nba-infoGraphic.jpg){.lightbox width="250px" fig-align="center"}
:::
:::::
...
![The NBA 2025 is the 4th edition released, and the first to be accompanied by a website.](./imgs/nba2004-2025.png){fig-align="center" width="600"}

The scope of the NBA is broad, assessing biodiversity at the ecosystem and species level, and addressing aspects of genetic diversity. The assessment covers all of South Africa's territory, across land and sea, including its subantarctic territory of the Prince Edward Islands. Information is organised by realm (terrestrial, freshwater (rivers and inland wetlands), estuarine and marine (benthic and pelagic)), and the cross-ream coastal zone and the subantarctic region. For species, information is organised by taxonomic group and summarised for each realm.
...
The shift to delivering the NBA as a website allows for more regular updates of components as they become available, rather than waiting for an official release. Keep checking the [what's new](./whatsnew-nba.qmd) section to see which sections have been updated.
