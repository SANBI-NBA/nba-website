...
![A team undertakes a BioBlitz in the proposed National Park in the grasslands of the Eastern Cape - these are citizen science driven events to find and identify as many species as possible over a short period of time. (© Greg Martindale)](imgs/gregmartindalebioblitz.png)

## The NBA has seven objectives
...
::: {.callout-note collapse="false" title="Workflows for analyses and indicators"}
...
::: {.callout-note collapse="false" title="Results of analyses"}
...
::: {.callout-note collapse="false" title="Key messages"}
...
::: {.callout-note collapse="false" title="Facts and statistics about the benefits of biodiversity"}
...
::: {.callout-note collapse="false" title="Priority actions, responses and interventions"}
...
::: {.callout-note collapse="false" title="Summaries"}
...
::: {.callout-note collapse="false" title="Popular products"}
...
![](imgs/KMGBF.png){fig-align="left" width="180"}

::: {#box-kmgbf .callout-note collapse="true" title="Kunming-Montreal Global Biodiversity Framework (KM-GBF)"}
In 2022, the Parties to the United Nations Convention on Biological Diversity (UNCBD) adopted the [Kunming-Montreal Global Biodiversity Framework (KM GBF).](https://www.cbd.int/gbf) The KM GBF is a global agreement aiming to halt and reverse biodiversity loss by 2030. It has 4 goals and 23 targets for 2030.
...
![](imgs/SDG.png){width="150"}

::: {.callout-note collapse="true" title="Sustainable Development Goals (SDGs)"}
...
![](imgs/UNCCD.png){width="220" height="70"}

::: {.callout-note collapse="true" title="United Nations Convention to Combat Desertification (UNCCD)"}
...
![](imgs/RAMSAR.png){width="100"}

::: {.callout-note collapse="true" title="Ramsar Convention on Wetlands of International Importance"}
The [Ramsar](https://www.ramsar.org/) treaty was adopted in 1971 and serves as the framework for the conservation and effective management of wetlands.
...
![](imgs/UNFCCC.JPG){width="250"}

::: {.callout-note collapse="true" title="United Nations Framework Convention on Climate Change (UNFCCC)"}
The Adaptation Committee of the [UNFCCC](https://www.unfccc.int/) has proposed a number of Ecosystems and Biodiversity indicators of relevance to the NBA.

Key linkages to NBA findings:
