...
-   **Workflows for analyses and indicators:** A key focus of NBA 2025 was to ensure that the workflows for undertaking these analyses were published in repositories hosted on platforms such as GitHub and GitLab. This ensures that the NBA analyses are reproducible and mitigates any loss of knowledge or data should there be a change in staff undertaking the analyses.
