...
![*Sand mining is as escalating pressure on the South African coast and in estuaries, impacting ecosystem services. (© Jacque Smit)*](imgs/17.%20Pg25_KMA2%20Coastal_Mining_%20Tormin_with%20cliff%20collapses%20-(c)%20Jacque_Smit_PTWC-56.png)

![*Mixed land use, ensuring corridors for biodiversity, is possible in South Africa's production landscapes. (© Endangered Wildlife Trust)* [**Possibly change to another mixed landuse image**] {.underline}](imgs/18.%20Pg25_KMA2_NBBN%20site%20visit_Mondi_1%20(c)%20EWT.png)
