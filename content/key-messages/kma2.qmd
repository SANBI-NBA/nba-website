...
::: {layout-ncol="2"}
![Sand mining is an escalating pressure on the South African coast and in estuaries, impacting coastal biodiversity and ecosystem services. Mining can be seen on the beach in the foreground and on the adjacent dunes. (© Jacque Smit)](imgs/17.%20Pg25_KMA2%20Coastal_Mining_%20Tormin_with%20cliff%20collapses%20-(c)%20Jacque_Smit_PTWC-56.png)

![Mixed land use, ensuring corridors for biodiversity, is possible in South Africa’s production landscapes, such as this plantation forestry landscape. (© Endangered Wildlife Trust)](imgs/18.%20Pg25_KMA2_NBBN%20site%20visit_Mondi_1%20(c)%20EWT.png)
:::
