...
::: {layout-ncol="2"}
![Scaling up renewable energy is part of South Africa’s Just Energy Transition, and must be accomplished in a way that considers biodiversity. For example, this blade patterning experiment is ongoing at the Umoya wind farm in Hopefield, where painted blades show reduced bird fatalities. (© Robert Simmons)](imgs/kma1_wind_RobertSimmons.png)

![Disruptive flooding is now a seasonal reality in several provinces due to climate change. In 2022, KwaZulu-Natal experienced extensive flood damage like the Umdloti beachfront in this image (© Ryan Daly). The Palmiet area was less affected thanks to the Palmiet Rehabilitation Project. The project had recruited EnviroChamps from the community to clear alien vegetation along the river and monitor for blockages of sewers and stormwater drains in the two years prior to the 2022 floods.](imgs/kma1_flood_RyanDaly.png)
:::
