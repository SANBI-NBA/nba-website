...
The International Union for the Conservation of Nature (IUCN) proposes a threats classification scheme with a hierarchical structure for various pressures on biodiversity. The NBA 2025 adopted this approach with some minor language changes. @fig-bub is for the realms, the coast and the subantarctic, and @fig-bub-sp is for taxonomic groups.
