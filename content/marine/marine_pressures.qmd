...
![South African fisheries provide food, employment and revenue and are making progress in addressing impacts on marine biodiversity. © Peter Chadwick, African Conservation Photographer.](imgs/045_Fisheries_©PeterChadwick_AfricanConservationPhotographer.png){width="80%" fig-align="left"}

::: {#box1 .callout-note .freshwater appearance="minimal" collapse="true"}
...
::: {#box3 .callout .box-within-box collapse="false"}
## Box 1. Improvements in shark control measures

The KwaZulu-Natal Sharks Board has taken several steps to reduce the impacts of lethal shark control measures on marine species. These include reducing the average length of nets deployed per annum by 87% from a peak of 44.5 km in 1992 to 5.7 km in 2025. Nets have been replaced with baited drum lines in several areas and a seasonal targeting approach to reduce negative impacts while maintaining bather safety. Nets are removed during the annual sardine run in winter to reduce marine mammal entanglements and mortalities on sharks and other species. Experimental work on mesh size, acoustic pingers and other innovations to reduce impacts have also been conducted and there is ongoing research to improve the evidence base for shark management. Such measures have resulted in an 80% reduction in total catch and substantially reduced mortalities of sharks and other marine species (KZN Sharks Board pers. comm.). A network of researchers tag sharks and use satellite and acoustic tracking to better understand shark movement. Such data are useful in better understanding shark distribution and risks in terms of location, season and other temporal trends.
...
::: {#box4 .callout-note .freshwater appearance="minimal" collapse="true"}
...
::: {#box6 .callout-note .freshwater appearance="minimal" collapse="true"}
...
![Flow reduction threatens marine ecosystems, species and associated fisheries benefits. © Bronwyn Goble, Oceanographic Reasearch Institute.](imgs/uThukela_plume_fluvial_fan_Bronwyn_Goble_ORI.png){width="80%" fig-align="left"}

::: {#box9 .callout-note .freshwater appearance="minimal" collapse="true"}
...
![Waste water discharge impacts biodiversity, the economy and human health. © Jean Tresfon.](imgs/DSC_0853_edit.jpg){width="80%" fig-align="left"}

::: {#box10 .callout-note .freshwater appearance="minimal" collapse="true"}
...
![Ammunition disposal in the ocean poses several risks to both species and ecosystems. © Jana Ulrich.](imgs/Jana_Ulrich_ammunition_KolbergerHeide-ju.png){width="80%" fig-align="left"}

::: {#box11 .callout-note .freshwater appearance="minimal" collapse="true"}
...
::: {#box13 .callout-note .freshwater appearance="minimal" collapse="true"}
...
Light pollution or artificial light at night can negatively impact species and ecosystems by interrupting species’ natural circadian rhythms, changing night-time activity through either negative or positive phototaxis [@duarte2019; @fobert2023]. Feeding, breeding and resting behaviours are affected with impacts on turtle hatchlings and seabirds and beach invertebrates of particular concern [@duarte2019; @harris2025a; @harris2025]. For example, several beach species including the Endangered Cape pill bugs, *Tylos capensis* (nocturnal sandy beach isopods; @harris2025a) are significantly less active at night when exposed to higher light intensities, which reduces their foraging time. Light pollution can also affect navigation of seabirds and cause grounding with risk of injury or mortality [@heswall2022].

Noise pollution is an increasing concern, particularly in aquatic environments where sound conductivity is greater than in air and where many species rely on sound for prey location and communication [@nelms2016; @duarte2021]. Sources of sound include seismic surveys [(Sink et al. 2024 seismic report)]{.mark}, shipping traffic, bunkering [@pichegru2022], various other commercial activities, and boating. Elevated underwater noise can cause direct mortality, lower immunity and increase health risks, change species distributions and disrupt foraging when predators, prey, or both avoid noisy areas, and disrupt reproduction, communication and social behaviour.
...
Limited progress in pressure mapping was achieved for the 2025 assessment but seismic surveys and submarine cables were mapped for inclusion in future assessments and an improved, finer resolution demersal trawl fishing layer has been compiled [@currie2023]. The work towards an Integrated Ecosystem Assessment for South Africa [@skein2022] also improved the understanding of pressure on marine biodiversity and was a key informant in the 2025 assessment [(Sink et al. 2024 seismic report)]{.mark}.
