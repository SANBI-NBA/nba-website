...
[//]: # (TO DO: Kerry intends to provide an image here — check if still needed given whale/sound image already present above)
:::
...
[//]: # (TO DO: Code repositories — Cumulative pressure and condition calculations and mapping: https://gitlab.com/marine_pressure_layers/pressure_layers — add when repo is ready to share)
