...
Skein et al. (2022) examined 17 key pressures from 17 different sectors and their links to 23 key ecosystem characteristics (@fig-risk-ass) that have implications for ecosystem services [@skein2022]. Fishing, petroleum (referred to as “Non-renewable (oil and gas)” in @fig-risk-ass) and shipping had the most widespread effects across the most ecosystem components, accounting for 30% of total linkage pathways identified, with fishing showing the most linkages overall. This is due to the extensive and complex nature of these three sectors, each of which comprise various components that may impact marine life in different ways. For example, offshore oil and gas sector activities include exploration (invasive and non-invasive), production and transport, each exerting different pressures on marine biodiversity. Anticipated [renewable energy](#renewable-energy) installations will have implications for marine ecosystems and species in future, through increased underwater noise, habitat modification and wildlife collisions, depending on the energy source.
...
Fisheries affect benthic and pelagic ecosystems through multiple pathways of impact [@skein2022], with the impact of the demersal trawl and longline fisheries on seabed habitats providing a straightforward example (@fig-risk-ass). Measures have been taken to manage the ecosystem impacts of trawl fishing through freezing the demersal hake trawl footprint, new co-developed spatial management measures and work to identify and protect Vulnerable Marine Ecosystems [@franken2025; ] \[[(Sink et al. 2025 - the trawl report)]{.mark}\]{.mark}.
